...
const Testimonials = (props) => {
  ...
  return (
    <div className=" w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-2xl">
      ...
      <div className=" bg-violet-400 hover:bg-violet-500 transition-all duration-300 cursor-pointer px-10 py-2 rounded-lg font-bold text-violet-100 text-lg mx-auto mt-3 shadow-2xl">
        <button onClick={surpriseHandler}>Surprise me Bitch</button>
      </div>
    </div>
  );
};
